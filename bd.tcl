...
#Daisy Chain connectors (not used, but these are the commands for placing the needed buffers if)
#cell xilinx.com:ip:util_ds_buf utils_ds_buf_1 {
#  C_SIZE 2
#} {
#  IBUF_DS_P daisy_p_i
#  IBUF_DS_N daisy_n_i
...
#  OBUF_DS_P daisy_p_o
#  OBUF_DS_N daisy_n_o
#  OBUF_IN utils_ds_buf_1/IBUF_OUT
#}
...
module RAM_WRITER_INTERFACE {
  ...
  axis_mux2_4x1/S_AXIS_3 ADC_INTERFACE/axi_red_pitaya_adc/DEBUG_M_AXIS
  axis_mux2_4x1/S_AXIS_2 ADC_INTERFACE/dummy_data_gen/DEBUG_M_AXIS
  axis_mux2_4x1/S_AXIS_1 ADC_INTERFACE/axis_mux_4x1/M_AXIS
...
set_property -dict [list CONFIG.FREQ_HZ {125000000}] [get_bd_intf_pins ADC_INTERFACE/dummy_data_gen/M_AXIS]
set_property -dict [list CONFIG.FREQ_HZ {125000000}] [get_bd_intf_pins ADC_INTERFACE/axis_mux_4x1/S_AXI]
set_property -dict [list CONFIG.FREQ_HZ {125000000}] [get_bd_intf_pins RAM_WRITER_INTERFACE/ram_writer/S_AXI]
set_property -dict [list CONFIG.FREQ_HZ {125000000}] [get_bd_intf_pins RAM_WRITER_INTERFACE/axis_mux2_4x1/S_AXIS_1]
set_property -dict [list CONFIG.FREQ_HZ {125000000}] [get_bd_intf_pins RAM_WRITER_INTERFACE/axis_mux2_4x1/S_AXIS_2]
set_property -dict [list CONFIG.FREQ_HZ {125000000}] [get_bd_intf_pins RAM_WRITER_INTERFACE/axis_mux2_4x1/S_AXIS_3]
set_property -dict [list CONFIG.FREQ_HZ {125000000}] [get_bd_intf_pins RAM_WRITER_INTERFACE/ram_writer/S_AXIS]
set_property -dict [list CONFIG.FREQ_HZ {125000000}] [get_bd_intf_pins RAM_WRITER_INTERFACE/axis_mux2_4x1/S_AXI]
...
addr $AXI_BASE_ADDR_RAM_WRITER_AXIS_MUX $AXI_SLAVE_RANGE RAM_WRITER_INTERFACE/axis_mux2_4x1/S_AXI /ps_0/M_AXI_GP0
...
# map axi red pitaya adc and axis mux:
addr $AXI_BASE_ADDR_RP_ADC $AXI_SLAVE_RANGE ADC_INTERFACE/axi_red_pitaya_adc/S_AXI /ps_0/M_AXI_GP0
addr $AXI_BASE_ADDR_ADC_AXIS_MUX $AXI_SLAVE_RANGE ADC_INTERFACE/axis_mux_4x1/S_AXI /ps_0/M_AXI_GP0

######## Dummy Data Generator ########
addr $AXI_BASE_ADDR_DUMMY_REGS $AXI_SLAVE_RANGE ADC_INTERFACE/dummy_data_gen/S_AXI_REGS /ps_0/M_AXI_GP0
addr $AXI_BASE_ADDR_DUMMY_BRAM $BRAM_AXI_RANGE ADC_INTERFACE/dummy_data_gen/S_AXI_BRAM /ps_0/M_AXI_GP0

# map axi red pitaya dac:
addr $AXI_BASE_ADDR_RP_DAC $AXI_SLAVE_RANGE DAC_INTERFACE/axis_red_pitaya_dac/S_AXI /ps_0/M_AXI_GP0

# create 3 additionaly ports on axi-smart-connect
...
connect_bd_intf_net [get_bd_intf_pins axi_smc/M12_AXI] [get_bd_intf_pins DAC_INTERFACE/axis_dac_bram_controller_port0/S_AXI]
connect_bd_intf_net [get_bd_intf_pins axi_smc/M13_AXI] [get_bd_intf_pins DAC_INTERFACE/axis_dac_bram_controller_port1/S_AXI]
